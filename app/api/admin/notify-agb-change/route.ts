    ...
    for (const student of students) {
      await transporter.sendMail({
        ...
        html: `
          ...
          Wende dich dazu an <a href="mailto:office@lernapp.at">office@lernapp.at</a>.</p>
          ...
          <p>Bei Fragen stehen wir dir gerne unter <a href="mailto:office@lernapp.at">office@lernapp.at</a> zur Verfügung.</p>
